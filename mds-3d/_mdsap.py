...
def _smacof_single(
    ...
    else: # TODO sa inteleg acest INIT
...
def smacof(
    ...
    *,
    ...
    random_state = check_random_state(random_state) # TODO CAT DE RANDOM ESTI?
    ...
    if hasattr(init, "__array__"): # TODO cat de random e?
