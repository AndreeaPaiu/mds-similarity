...
def plot_mds_3D_pearsonr(collections, aps):
    ...
    plt.title(f'[Pearsonr][all aps] Reprezentarea a {len(count_floors)} etaje')
    handles = []
    ...
    fig.savefig(f"images/label_mds_3D_pearsonr_2_floors.svg", bbox_inches='tight')
