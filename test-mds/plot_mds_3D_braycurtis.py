...
def plot_mds_3D_braycurtis(collections, aps):
    ...
    plt.title(f'[Braycursits][all aps] Reprezentarea a {len(count_floors)} etaje')
    handles = []
    ...
    # fig.savefig(f"images/mds_3D_braycurtis_2_floors.svg", bbox_inches='tight')
    fig.savefig(f"images/label_mds_3D_braycurtis_2_floors.svg", bbox_inches='tight')
