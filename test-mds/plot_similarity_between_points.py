...
def plot_similarity_between_points(collections, aps=[], selection='All', simil_method=braycurtis, title='', file_name='images/test.svg'):
...
def plot_all_similarity_between_points(collections, simil_methods, selections, aps=[]):
    for simil_method in simil_methods:
        for selection in selections:
            plot_similarity_between_points(
                ...
                file_name=f"images/{simil_method.__name__}-vs-distance-ds1-with-{selection}-aps.svg"
            )