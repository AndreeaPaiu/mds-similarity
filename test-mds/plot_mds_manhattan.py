...
def plot_mds_manhattan(collections, aps):
    ...
    for i in range(len(collections)):
        for j in range(len(collections)):
            ...
            rssi1, rssi2 = compare_locations(collections[i], collections[j], return_type='rssi', all_aps=aps)
    ...
    plt.grid()
    plt.show()
    fig.savefig(f"images/label_mds_manhattan.svg", bbox_inches='tight')
    # fig.savefig(f"images/label_mds_manhattan_all_floors.svg", bbox_inches='tight')
